...
<html lang="en">
  <head>
    <title>Check-in Time Graph Page</title>
  ...
  <body style="background-color: #e6e6e6;">
    ...
    <div style="padding: 30px;">
      <H2 style="text-align: center; font-family: Helvetica, Sans-Serif;">Chart Check-in Time</H2>
      <div>
    ...
    <script>
        <?php
          $sql = "SELECT COUNT(*) AS jumlah FROM reservasi WHERE check_in like 'Senin%'";
          $query1 = mysqli_query ($conn, $sql);
          $sql = "SELECT COUNT(*) AS jumlah FROM reservasi WHERE check_in like 'Selasa%'";
          $query2 = mysqli_query ($conn, $sql);
          $sql = "SELECT COUNT(*) AS jumlah FROM reservasi WHERE check_in like 'Rabu%'";
          $query3 = mysqli_query ($conn, $sql);
          $sql = "SELECT COUNT(*) AS jumlah FROM reservasi WHERE check_in like 'Kamis%'";
          $query4 = mysqli_query ($conn, $sql);
          $sql = "SELECT COUNT(*) AS jumlah FROM reservasi WHERE check_in like 'Jumat%'";
          $query5 = mysqli_query ($conn, $sql);
          $sql = "SELECT COUNT(*) AS jumlah FROM reservasi WHERE check_in like 'Sabtu%'";
          $query6 = mysqli_query ($conn, $sql);
          $sql = "SELECT COUNT(*) AS jumlah FROM reservasi WHERE check_in like 'Minggu%'";
